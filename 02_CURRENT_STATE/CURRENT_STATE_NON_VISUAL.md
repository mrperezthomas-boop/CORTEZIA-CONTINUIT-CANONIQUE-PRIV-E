...
## BIBLE + PARCOURS D’ÂGE — 2026-09-03
CORTEZIA_BIBLE.md + CORTEZIA_BIBLE.json sont désormais la synthèse canonique UI/produit/workflow.
Parcours initial actif : Basic Gate +18 → accueil SAFE. La vérification officielle d’âge est séparée et n’est pas automatique après le gate.
Besoin admin ajouté : éditeur visuel intégré au vrai admin. Puck = recommandation actuelle, NON IMPLÉMENTÉ.
## PUCK ADMIN — 2026-09-03
Puck = SELECTED_NOT_IMPLEMENTED.
Pack d’implémentation préparé : CORTEZIA_PUCK_ADMIN.zip.
Objectif du pack : /admin/design + Accueil pilote + persistance + auth admin locale sûre si nécessaire, sans Drive/GitHub/audit global côté Codex.
.